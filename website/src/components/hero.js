export default function Hero() {
  return (
    <div className='px-8 md:px-4 w-full flex flex-col items-center ml-auto mr-auto gap-6'>
      <h1 className='text-4xl font-bold text-center mb-4 max-w-2xl'>Combining the best parts of <span className='text-python'>Python</span> and <span className='text-javascript'>Javascript</span> into <span className='underline underline-offset-2'>one language.</span></h1>
